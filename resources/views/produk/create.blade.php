    ...
    <form action="{{ route('tambah') }}" method="post" enctype="multipart/form-data" class="p-2">
        ...
        <div class="mx-5 mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea name="deskripsi" id="deskrisi" cols="30" rows="10" class="block p-2.5 w-full text-sm rounded-lg border bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500" placeholder="Deskripsi Produk" required></textarea>
                @error('deskripsi')
                    <div>
                        <p class="text-red-500 text-base">{{ $message }}</p>
                    </div>
